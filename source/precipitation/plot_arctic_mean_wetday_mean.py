...
cfsr_fili = 'cfsr_arctic_mean_wetday_mean.nc'
erai_fili = 'era_interim_arctic_mean_wetday_mean.nc'
mer2_fili = 'merra2_arctic_mean_wetday_mean.nc'
cfs2_fili = 'cfsr2_arctic_mean_wetday_mean.nc'
merr_fili = 'merra_arctic_mean_wetday_mean.nc'
ja55_fili = 'jra55_arctic_mean_wetday_mean.nc'
...
ax.set_title('April to August Wetday Mean', fontsize=20)
...
fig.savefig('reanalysis_arctic_mean_wetday_mean.png')
