...
cfsr = get_data(fili['CFSR'], 'fwetdays')
erai = get_data(fili['ERAI'], 'fwetdays')
mer2 = get_data(fili['MERRA2'], 'fwetdays')
merr = get_data(fili['MERRA'], 'fwetdays')
ja55 = get_data(fili['JRA55'], 'fwetdays')
...
fig.savefig('reanalysis_arctic_mean_wetday_frequency.Nh50km.png')
