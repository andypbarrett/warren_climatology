...
cfsr_fili = 'cfsr_arctic_mean_wetday_frequency.nc'
erai_fili = 'era_interim_arctic_mean_wetday_frequency.nc'
mer2_fili = 'merra2_arctic_mean_wetday_frequency.nc'
cfs2_fili = 'cfsr2_arctic_mean_wetday_frequency.nc'
merr_fili = 'merra_arctic_mean_wetday_frequency.nc'
ja55_fili = 'jra55_arctic_mean_wetday_frequency.nc'
...
ax.set_title('April to August Wetday Frequency', fontsize=20)
ax.set_ylabel('P(wetday)', fontsize=20)
ax.set_xlabel('')
ax.tick_params(labelsize=20)

ax.legend(fontsize=18, bbox_to_anchor=(0.6,0.05), loc=3, borderaxespad=0, ncol=2)

fig.savefig('reanalysis_arctic_mean_wetday_frequency.png')
