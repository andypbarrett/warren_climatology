...
fili = {'CFSR': '/disks/arctic5_raid/abarrett/CFSR/PRATE/CFSR.flxf06.gdas.PRECIP_STATS.accumulation.annual.Nh50km.AOSeries.nc',
        ...
        'ERA5': '/projects/arctic_scientist_data/Reanalysis/ERA5/daily/TOTPREC/era5.single_level.PRECIP_STATS.accumulation.annual.AOSeries.nc4',}
...
df = pd.concat([get_data(fili['CFSR'], 'precTot').to_dataframe('CFSR'),
                ...
                get_data(fili['JRA55'], 'precTot').to_dataframe('JRA55'),
                get_data(fili['ERA5'], 'precTot').to_dataframe('ERA5'),], axis=1)
